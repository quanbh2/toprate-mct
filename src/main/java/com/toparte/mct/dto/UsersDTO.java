...
import com.toprate.base.common.AdjHistory;
import com.toprate.base.utils.CustomJsonDateDeserializer;
import com.toprate.base.utils.CustomJsonDateDeserializerAdmin;
import com.toprate.base.utils.CustomJsonDateSerializer;
import com.toprate.base.utils.CustomJsonDateSerializerAdmin;
...
public class UsersDTO extends QlanBaseDTO<Users> {
	...
	@JsonDeserialize(using = CustomJsonDateDeserializerAdmin.class)
	@JsonSerialize(using = CustomJsonDateSerializerAdmin.class)
	...
	// private SalonDTO salonDto = new SalonDTO();
	//
	...
	public String toString() {
		return "users{" + "userId :" + userId + "," + "userName :" + userName + "," + "fullName :" + fullName + ","
				+ "password :" + password + "," + "email :" + email + "," + "deptId :" + deptId + "," + "status :"
				+ status + "," + "teFax :" + teFax + "," + "gender :" + gender + "," + "birthPlace :" + birthPlace + ","
				+ "identityCard :" + identityCard + "," + "issuePlaceIdent :" + issuePlaceIdent + ","
				+ "issueDateIdent :" + issueDateIdent + "," + "description :" + description + "," + "validFrom :"
				+ validFrom + "," + "validTo :" + validTo + "," + "checkIp :" + checkIp + "," + "ip :" + ip + ","
				+ "lastChangePassword :" + lastChangePassword + "," + "column20 :" + column20 + "," + "createUser :"
				+ createUser + "," + "createDate :" + createDate + "," + "loginFailureCount :" + loginFailureCount + ","
