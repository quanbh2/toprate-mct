package com.toprate.mct.constant;
...
public class Constants {
	...
	public interface USER_TYPE {
		...
		public final Long STAFF = 1L;
		public final Long CUSTOMER_V0 = 2L;
		public final Long CUSTOMER_V1 = 3L;
		public final Long CUSTOMER_V2 = 4L;
		public final Long CUSTOMER_V3 = 5L;
	}

	public interface STATUSPOST {
		public final Long PENDING = (long) 0;
		public final Long APPROVED = (long) 1;
		public final Long DENIED = (long) 2;
		public final Long CLOSED = (long) 3;
		public final Long EXPIRES = (long) 4;
	}
	
	public interface STATUSDELETE {
		public final Long NOTYET = (long) 0;
		public final Long DELETED = (long) 1;
	}
	
	public interface SORTBY {
		public final Long YEAR_ASC = (long)1;
		public final Long YEAR_DESC = (long)2;
		public final Long PRICE_ASC = (long)3;
		public final Long PRICE_DESC = (long)4;
	}
	
	public interface STATUS_TYPE {
		public final Long STATUS_V0 = 1L;
		public final Long STATUS_V1 = 2L;
		public final Long STATUS_V2 = 3L;
		public final Long STATUS_V3 = 4L;
	}
	 ...
	 * 
	 * 
	 * public final String INSERT = "Thêm mới bản ghi "; public final String UPDATE
	 * = "Cập nhật bản ghi "; public final String DELETE = "Xóa bản ghi "; public
	 * final String LOCK = "Khóa bản ghi "; public final String UNLOCK = "Mở khóa ";
	 * public final String RESET = "Reset mật khẩu "; }
	 */
	public static final String ROLE_CODE_EXITS = "role_code_exits";
	public static final String PROVINCE_CODE_EXITS = "province_code_exits";
